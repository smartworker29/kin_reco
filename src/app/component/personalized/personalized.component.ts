...
export class PersonalizedComponent implements OnInit {
  ...
  get_event_details() {
    const url = API_URL + 'events/?tags=popular&distance=100&order_by=date_dist_asc&limit=90';
    ...
    const urlNearby = API_URL + 'events/?order_by=date_dist_asc&distance=15&limit=90';
    ...
    const urlWeekend = API_URL + 'events/?event_range_str=weekend&order_by=date_dist_asc&distance=50&limit=90';
