...
export class SwalService {
  ...
  showWarning(message: any){
    ...
    Swal.fire({
     ...
     footer: '<p style ="font-size:14px;font-family: Montserrat;"><span class="kin-pop"> New to Kin? </span></p>' + ' ' +  `<a style= "color:#000000;margin-left:4px;font-family: Montserrat;font-size:14px;" href="/redirecting"> Create an account - it's free!!!</a>`,
    }).then((result) => {
      if (result.value) {
        this.auth.login();
